...
function pwgen() {
    let userChoice = prompt('Select amount of character in password 8-60')
    ...
    while (
        ...
        alert('You must choose a number between 8-60')
        userChoice = prompt('Try again! Choose a number between 8-60!')
    }
